...
shop(FALSE) # Run the function by setting the one and only argument (eggs) to either TRUE or FALSE
...
In the first scenario, all the programmer's decisions are conditional on the presence or absence of eggs, and all the comes of those decisions only involve milk. 
...
*In this case,* the desired outcome was achieved, but it was a bit lucky.
