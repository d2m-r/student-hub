...
You may additionally or alternatively complete the [Level 1 wrangling assignment](../wrangle-level-1-starwars/wrangle-level-1-starwars.qmd), which uses a simpler goal dataframe and provides more detailed instructions.
...
If you optionally chose to continue transforming (see more info below), that should be a *different dataframe.* 
